...
ModernMapMarkers_Locale:RegisterMarkers("deDE", {
    ...
    ["Stormwind Vault - Horde Entrance"]    = "Gewölbe von Sturmwind - Horde-Eingang",
    ...
    ["Emerald Dragon - Spawn Point 4 of 4"] = "Smaragddrache - Spawnpunkt 4 von 4",
    ["Azuregos"]               = "Azuregos",
    ["Cla'ckora"]              = "Cla'ckora",
    ["Concavius"]              = "Concavius",
    ...
    ["Boat to Sardor Isle"]        = "Schiff nach Sardorinsel",
    ["Boat to Revantusk Village"]  = "Schiff nach Revantusk",
    ["Boat to Sparkwater Port"]    = "Schiff nach Funkelwasserhafen",
    ["Zeppelins to UC & Grom'Gol"]      = "Zeppeline nach UC & Grom'Gol",
    ["Zeppelins to TB & Kargath"]        = "Zeppeline nach TB & Kargath",
    ["Zeppelin to Orgrimmar"]            = "Zeppelin nach Orgrimmar",
    ["Zeppelins to Orgrimmar & Grom'Gol"] = "Zeppeline nach Orgrimmar & Grom'Gol",
    ["Zeppelins to UC & Orgrimmar"]      = "Zeppeline nach UC & Orgrimmar",
    ["Tram to Stormwind"]     = "Tram nach Sturmwind",
    ["Tram to Ironforge"]     = "Tram nach Eisenschmiede",
