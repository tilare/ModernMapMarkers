...
ModernMapMarkers_Locale:RegisterMarkers("zhCN", {
    ...
    ["Lord Kazzak"]            = "卡扎克领主",
    ["Ostarius"]               = "Ostarius",
    ["Dark Reaver of Karazhan"]  = "卡拉赞的黑暗掠夺者",
    ["Nerubian Overseer"]      = "蚁魔巴监工官",

    -- Transports
    ["Boat to Stormwind"]          = "前往暴风城",
    ["Boat to Alah'Thalas"]        = "前往Alah'Thalas",
    ["Boat to Rut'Theran Village"] = "前往鲁爦兰村",
    ["Boat to Auberdine"]          = "前往奥伯丁",
    ["Boat to Menethil Harbor"]    = "前往米奇希尔港",
    ["Boat to Theramore Isle"]     = "前往塞拉摩岛",
    ["Boat to Booty Bay"]          = "前往藏宝海湾",
    ["Boat to Ratchet"]            = "前往棘齿城",
    ["Boat to Forgotten Coast"]    = "前往遗忘海岸",
    ["Boat to Sardor Isle"]        = "前往萨多尔岛",
    ["Boat to Revantusk Village"]  = "前往Revantusk",
    ["Boat to Sparkwater Port"]    = "前往火水港",
    ["Zeppelins to UC & Grom'Gol"]      = "飞艇前往幽暗城和格罗高",
    ["Zeppelins to TB & Kargath"]        = "飞艇前往雷霆崖和卡加斯",
    ["Zeppelin to Orgrimmar"]            = "飞艇前往奥格瑞玛",
    ["Zeppelins to Orgrimmar & Grom'Gol"] = "飞艇前往奥格瑞玛和格罗高",
